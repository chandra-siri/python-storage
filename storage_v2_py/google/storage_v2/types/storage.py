...
class ListBucketsResponse(proto.Message):
    ...
    Attributes:
        buckets (MutableSequence[google.storage_v2.types.Bucket]):
            The list of items.
        next_page_token (str):
...
class ComposeObjectRequest(proto.Message):
    ...
    Attributes:
        destination (google.storage_v2.types.Object):
            Required. Properties of the resulting object.
        source_objects (MutableSequence[google.storage_v2.types.ComposeObjectRequest.SourceObject]):
    ...
    class SourceObject(proto.Message):
        ...
        Attributes:
            ...
            generation (int):
                ...
                use as the source.
            object_preconditions (google.storage_v2.types.ComposeObjectRequest.SourceObject.ObjectPreconditions):
...
class BidiReadObjectSpec(proto.Message):
    ...
    Attributes:
        ...
        read_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            This field is a member of `oneof`_ ``_read_mask``.
        read_handle (google.storage_v2.types.BidiReadHandle):
...
class BidiReadObjectRequest(proto.Message):
    ...
    Attributes:
        read_object_spec (google.storage_v2.types.BidiReadObjectSpec):
            ...
            the object to read.
        read_ranges (MutableSequence[google.storage_v2.types.ReadRange]):
...
class BidiReadObjectResponse(proto.Message):
    ...
    Attributes:
        object_data_ranges (MutableSequence[google.storage_v2.types.ObjectRangeData]):
...
class BidiWriteObjectRedirectedError(proto.Message):
    ...
    Attributes:
        routing_token (str):
            ...
            This field is a member of `oneof`_ ``_routing_token``.
        write_handle (google.storage_v2.types.BidiWriteHandle):
...
class BidiReadObjectError(proto.Message):
    ...
    Attributes:
        read_range_errors (MutableSequence[google.storage_v2.types.ReadRangeError]):
...
class ObjectRangeData(proto.Message):
    ...
    Attributes:
        ...
        read_range (google.storage_v2.types.ReadRange):
...
class BidiWriteObjectRequest(proto.Message):
    ...
    Attributes:
        ...
        write_object_spec (google.storage_v2.types.WriteObjectSpec):
            ...
            This field is a member of `oneof`_ ``first_message``.
        append_object_spec (google.storage_v2.types.AppendObjectSpec):
...
class Bucket(proto.Message):
    ...
    Attributes:
        ...
        acl (MutableSequence[google.storage_v2.types.BucketAccessControl]):
            Optional. Access controls on the bucket. If
            iam_config.uniform_bucket_level_access is enabled on this
            bucket, requests to set, read, or modify acl is an error.
        default_object_acl (MutableSequence[google.storage_v2.types.ObjectAccessControl]):
        ...
        cors (MutableSequence[google.storage_v2.types.Bucket.Cors]):
        ...
        custom_placement_config (google.storage_v2.types.Bucket.CustomPlacementConfig):
            ...
            dual-region].
        autoclass (google.storage_v2.types.Bucket.Autoclass):
        ...
        hierarchical_namespace (google.storage_v2.types.Bucket.HierarchicalNamespace):
        ...
        soft_delete_policy (google.storage_v2.types.Bucket.SoftDeletePolicy):
        ...
        ip_filter (google.storage_v2.types.Bucket.IpFilter):
    ...
    class Lifecycle(proto.Message):
        ...
        Attributes:
            rule (MutableSequence[google.storage_v2.types.Bucket.Lifecycle.Rule]):
    ...
    class IpFilter(proto.Message):
        ...
        Attributes:
            ...
            public_network_source (google.storage_v2.types.Bucket.IpFilter.PublicNetworkSource):
                Public IPs allowed to operate or access the
                bucket.

                This field is a member of `oneof`_ ``_public_network_source``.
            vpc_network_sources (MutableSequence[google.storage_v2.types.Bucket.IpFilter.VpcNetworkSource]):
...
class Object(proto.Message):
    ...
    Attributes:
        ...
        cache_control (str):
            ...
            ``public, max-age=3600``.
        acl (MutableSequence[google.storage_v2.types.ObjectAccessControl]):
        ...
        customer_encryption (google.storage_v2.types.CustomerEncryption):
        ...
        retention (google.storage_v2.types.Object.Retention):
    ...
    class Retention(proto.Message):
        ...
        Attributes:
            mode (google.storage_v2.types.Object.Retention.Mode):
...
class ListObjectsResponse(proto.Message):
    ...
    Attributes:
        objects (MutableSequence[google.storage_v2.types.Object]):
            The list of items.
