...
class ListBucketsPager:
    ...
    :class:`google.storage_v2.types.ListBucketsResponse` object, and
    ...
    All the usual :class:`google.storage_v2.types.ListBucketsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.storage_v2.types.ListBucketsRequest):
                The initial request object.
            response (google.storage_v2.types.ListBucketsResponse):
...
class ListObjectsPager:
    ...
    This class thinly wraps an initial
    :class:`google.storage_v2.types.ListObjectsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``objects`` field.
    ...
    All the usual :class:`google.storage_v2.types.ListObjectsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.storage_v2.types.ListObjectsRequest):
                The initial request object.
            response (google.storage_v2.types.ListObjectsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
