...
class StorageAsyncClient:
    ...
    async def delete_bucket(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.DeleteBucketRequest, dict]]):
    ...
    async def get_bucket(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.GetBucketRequest, dict]]):
    ...
    async def create_bucket(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.CreateBucketRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            bucket (:class:`google.storage_v2.types.Bucket`):
    ...
    async def list_buckets(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.ListBucketsRequest, dict]]):
        ...
        Returns:
            google.storage_v2.services.storage.pagers.ListBucketsAsyncPager:
    ...
    async def lock_bucket_retention_policy(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.LockBucketRetentionPolicyRequest, dict]]):
    ...
    async def update_bucket(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.UpdateBucketRequest, dict]]):
    ...
    async def compose_object(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.ComposeObjectRequest, dict]]):
    ...
    async def delete_object(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.DeleteObjectRequest, dict]]):
    ...
    async def restore_object(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.RestoreObjectRequest, dict]]):
    ...
    async def cancel_resumable_write(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.CancelResumableWriteRequest, dict]]):
    ...
    async def get_object(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.GetObjectRequest, dict]]):
    ...
    def read_object(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.ReadObjectRequest, dict]]):
    ...
    def bidi_read_object(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            requests (AsyncIterator[`google.storage_v2.types.BidiReadObjectRequest`]):
        ...
        Returns:
            AsyncIterable[google.storage_v2.types.BidiReadObjectResponse]:
    ...
    async def update_object(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.UpdateObjectRequest, dict]]):
                The request object. Request message for UpdateObject.
            object_ (:class:`google.storage_v2.types.Object`):
    ...
    def bidi_write_object(self,
        ...
        Args:
            requests (AsyncIterator[`google.storage_v2.types.BidiWriteObjectRequest`]):
        ...
        Returns:
            AsyncIterable[google.storage_v2.types.BidiWriteObjectResponse]:
    ...
    async def list_objects(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.ListObjectsRequest, dict]]):
        ...
        Returns:
            google.storage_v2.services.storage.pagers.ListObjectsAsyncPager:
                The result of a call to
                Objects.ListObjects
                Iterating over this object will yield
                results and resolve additional pages
    ...
    async def rewrite_object(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.RewriteObjectRequest, dict]]):
    ...
    async def start_resumable_write(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.StartResumableWriteRequest, dict]]):
    ...
    async def query_write_status(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.QueryWriteStatusRequest, dict]]):
    ...
    async def move_object(self,
        ...
        Args:
            request (Optional[Union[google.storage_v2.types.MoveObjectRequest, dict]]):
